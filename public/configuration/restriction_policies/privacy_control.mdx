...
<Tabs>
  <Tab title="Cookie filter">
    ...
    <Frame caption="Cookie list walk">
      <img src="/images/configuration/cookie_filter_flowchart.svg" alt="Cookie list walk" />
    </Frame>
  ...
  <Tab title="Header filter">
    ...
    <Frame caption="Header filter flow">
      <img src="/images/configuration/header_filter_flowchart.svg" alt="Header filter flow" />
    </Frame>
  ...
  <Tab title="Elevated Privacy">
    ...
    <Frame caption="Privacy level selection">
      <img src="/images/configuration/elevated_privacy_flowchart.svg" alt="Privacy level selection" />
    </Frame>
