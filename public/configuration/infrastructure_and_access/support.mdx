...
and [Self-Service Portal](/architecture/interface/self_service_portal)). The two are easy to
...
<Frame caption="Support — operational tool cards">
  <img src="/images/configuration/support-operational_tools.webp" alt="SafeSquid console Support page showing the ten operational tool cards with Restart SafeSquid circled" />
</Frame>
...
- **Startup params** — "Edit SafeSquid params." Web UI editor for the same tunables covered in
  [startup.ini tunables](/configuration/start_here/startup_ini) — confirm before assuming this
...
2. After uploading a new activation key on [Subscription](/configuration/infrastructure_and_access/subscription),
