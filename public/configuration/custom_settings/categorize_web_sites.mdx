...
<Frame caption="Categorize Web-Sites — CATEGORY EDITOR">
  <img src="/images/configuration/categorize_web_sites-category_editor.webp" alt="SafeSquid console showing the Categorize Web-Sites Category Editor with the Search for category box circled" />
</Frame>
