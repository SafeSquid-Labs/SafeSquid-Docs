...
The console splits DLP into three tabs. The MIME walk and the OCR walk are separate stages of
the same upload inspection — see **Processing flow** above for how they hand off.
...
<Tabs>
  ...
  <Tab title="DLP policies">

    ## DLP policy row fields
  ...
  <Tab title="OCR policies">

    ## OCR policy row fields
