...
<Frame caption="Cumulative scoring flow">
  <img src="/images/configuration/text_analyzer_flowchart.svg" alt="Cumulative scoring flow" />
</Frame>
...
<Frame caption="Text analyzer — Global fields">
  <img src="/images/configuration/text_analyzer-global.webp" alt="SafeSquid console showing Text analyzer Global fields with Threshold set to 100, the Edit Policy icon circled" />
</Frame>
