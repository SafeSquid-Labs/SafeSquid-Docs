...
<Frame caption="ClamAV scan flow">
  <img src="/images/configuration/clam_antivirus_flowchart.svg" alt="ClamAV scan flow" />
</Frame>
...
<Frame caption="Clam antivirus — Global fields">
  <img src="/images/configuration/clam_antivirus-global.webp" alt="SafeSquid console showing Clam antivirus Global fields with the clamd socket path and virus template, the Edit Policy icon circled" />
</Frame>
