...
<Frame caption="ICAP row walk">
  <img src="/images/configuration/icap_flowchart.svg" alt="ICAP row walk" />
</Frame>
...
{/* source: https://www.safesquid.com/md/icap.md */}
...
<Frame caption="ICAP — ICAP rows">
  <img src="/images/configuration/icap-rows.webp" alt="SafeSquid console showing ICAP rows for ClamAV REQMOD and RESPMOD with ICAP Timeout and Threat ID Header fields, the Edit Policies icon on the first row circled" />
</Frame>
