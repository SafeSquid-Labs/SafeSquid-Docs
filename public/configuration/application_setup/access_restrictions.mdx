...
<Frame caption="Processing flow — policy Deny, Allow list pass">
  <img src="/images/configuration/access_restrictions_flowchart.svg" alt="Access check flow for policy Deny" />
</Frame>
...
<Frame caption="Access restrictions — Allow list rows">
  <img src="/images/configuration/access_restrictions-allow_list.webp" alt="SafeSquid console showing Access restrictions Allow list rows with the bypass-authentication and tunnelled-UI-access entries, the Edit Policies icon on the first row circled" />
</Frame>
