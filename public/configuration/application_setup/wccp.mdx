...
- **Acceptable Assignment Method (assignment_method)** — Method used when SafeSquid becomes the designated proxy: `HASH` (default) or `MASK`. *Default disputed between sources — confirm against the live console before relying on either.*
