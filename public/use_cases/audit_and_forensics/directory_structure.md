...
description: SafeSquid SWG Directories reference and operational guidance for SafeSquid SWG administrators.
keywords:
  - directory structure
  - SafeSquid
  - reference
...
SafeSquid stores **tcp_tune.sh** script in the directory **/etc/init.d/** for TCP tuning. This script will optimize/set some of the values of the TCP parameters like
...
- **[config_XXXX@YYYY_ZZZZ.xml](mailto:config_XXXX@YYYY_ZZZZ.xml)**: A backup file representing the last saved configuration, where:
...
- Use [Security Logs](/use_cases/audit_and_forensics/security_logs) to interpret log paths.
- Use [Audit and Forensics](/use_cases/audit_and_forensics/audit_forensics) to plan evidence retention.
