...
keywords: ["block emails using keywords SafeSquid", "block archives using keywords SafeSquid", "content filtering SafeSquid", "data leakage protection SafeSquid", "block social media posts SafeSquid"]
---
...
:::note After configuring the policy as above, go to the Support page and click Refresh to refresh subscription details. :::
...
Open [www.facebook.com](http://www.facebook.com) and log in with test credentials.
...
If you still got any problem, you can send us mail at [support@safesquid.net](mailto:support@safesquid.net)