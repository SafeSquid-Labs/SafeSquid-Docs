...
### 3. [Architecture](/safesquid_swg/architecture/safesquid_swg) — Detect Apps by Traffic Fingerprints
...
→ [Review the architecture guides](/safesquid_swg/architecture/safesquid_swg)
