...
keywords: ["block personal gmail SafeSquid", "allow google corporate accounts SafeSquid", "block personal gmail accounts", "corporate email restriction SafeSquid", "safe web gateway gmail restriction"]
---
...
:::note Administrators can add User Groups to restrict the policy to specific groups. :::
...
:::note Multiple domains: separate each with a comma, no space. :::
