...
keywords: ["homograph detection", "IDN attacks", "SafeSquid DNS security"]
---
...
:::tip **Combine with Other Defenses** Homograph detection works best alongside [DNSBL](/DNSBL) (block known-bad domains), [SSL Inspection](/SSL_Inspection) (detect fake certificates), and user security awareness training. :::
...
1. **Access Configuration Portal**<br />Navigate to **Real Time Content Security** → **DNS Blacklist** <img src="/images/Homographic_Detection/homograph_config.webp" alt="Homograph Configuration" />
2. **Enable Homograph Detection**
   - **Enabled:** Set to **TRUE**
   - **Save** the configuration
3. **Apply Changes**<br />Click **Apply** to activate the new policy.
