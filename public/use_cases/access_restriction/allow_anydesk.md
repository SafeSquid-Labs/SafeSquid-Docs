...
keywords: ["Allow Anydesk SafeSquid", "bypass SSL inspection Anydesk", "SafeSquid remote desktop access", "SafeSquid user-agent filtering", "SafeSquid access profile configuration"]
---
...
:::note Remote applications like Anydesk® and Ammyadmin™ do not support SSO authentication. If SSO authentication is enabled, bypass it for these applications. :::
...
![Save Allow anydesk policy](/images/How_To/Allow_anydesk/image12.webp)

![Save configuration of policy to allow anydesk](/images/How_To/Allow_anydesk/image13.webp)
