...
keywords: ["SafeSquid compliance templates", "PCI-DSS DLP patterns", "HIPAA data protection", "GDPR compliance proxy", "regulatory compliance filtering", "sensitive data detection", "credit card number detection", "PII protection SafeSquid"]
---
...
:::note These templates provide detection patterns only. They do not by themselves make an environment compliant. Combine them with [Access Restriction](/Access_Restriction), HTTPS inspection, logging, governance, retention, and review processes. :::
...
Add Text Analyser policies using patterns from this document. Start with logging or limited pilot enforcement to assess false positive rates.
