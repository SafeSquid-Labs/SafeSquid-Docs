...
keywords: ["block advertisements SafeSquid", "block banners SafeSquid", "secure web gateway ads blocking", "SafeSquid ad blocking configuration", "ads and banners blocking SafeSquid"]
---
...
- **Traffic:** Open a site that normally shows ads (e.g. [https://www.youtube.com/](https://www.youtube.com/)); ads should be replaced by the SafeSquid template.
...
:::note Administrators can replace the default template with a custom template. :::
