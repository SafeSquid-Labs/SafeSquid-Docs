...
keywords: ["active directory sso SafeSquid", "RODC kerberos SafeSquid", "negotiate_ldap_auth RODC", "sso setup RODC", "SafeSquid RODC authentication"]
---
...
:::warning Ensure the **Ldap Bind Method** is set to **NEGOTIATE\_LDAP\_AUTH**. This is the trigger that initiates Kerberos ticket exchange. :::
