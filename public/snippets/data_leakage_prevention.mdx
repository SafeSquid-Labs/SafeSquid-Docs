...
→ [Configure Text Analyser](/use_cases/data_leakage_prevention/text_analyser)
...
→ [Configure Image Analyser](/use_cases/data_leakage_prevention/image_analyser_ai)
...
→ [Load Compliance Templates](/use_cases/access_restriction/compliance_templates)
...
**Action:** [Enable SSL Inspection](/use_cases/ssl_inspection/ssl_inspection) and deploy the Root CA to client devices.
...
**Action:** [Load Compliance Templates](/use_cases/access_restriction/compliance_templates) in the Text Analyser configuration.
...
**Action:** [Configure Text Analyser](/use_cases/data_leakage_prevention/text_analyser)
...
**Action:** [Configure Access Restrictions](/use_cases/access_restriction/access_restriction) with DLP profile matching.
...
**Action:** [Configure SIEM Integration](/use_cases/integrations/integrations) with syslog forwarding.
...
**Solution:** [Enable SSL Inspection](/use_cases/ssl_inspection/ssl_inspection) first, deploy Root CA to clients, then enable DLP.
...
**Solution:** Enable [archive decompression](/use_cases/content_modifier/content_modifier) in Content Modifier. SafeSquid will extract and scan ZIP/RAR contents before allowing upload.
...
**Solution:** Enable [Image Analyser (AI-powered)](/use_cases/data_leakage_prevention/image_analyser_ai) so image-based egress is not a blind spot.
...
**Prerequisites:**
- [SSL Inspection](/use_cases/ssl_inspection/ssl_inspection) — Required to inspect encrypted uploads (90% of traffic)
- [Authentication](/use_cases/authentication/authentication) — User identity needed for per-user DLP policies

**Next Steps:**
- [Text Analyser Configuration](/use_cases/data_leakage_prevention/text_analyser) — Fine-tune regex patterns
- [Image Analyser (AI-powered)](/use_cases/data_leakage_prevention/image_analyser_ai) — OCR for screenshots
- [Access Restrictions](/use_cases/access_restriction/access_restriction) — Link DLP detections to block/log actions
- [SIEM Integration](/use_cases/integrations/integrations) — Forward DLP alerts to Splunk, QRadar, etc.

**Troubleshooting:**
- [DLP False Positives](/troubleshooting/troubleshooting) — How to tune regex patterns, whitelist test data

**Use Cases:**
- [Block Personal Gmail, Allow Corporate](/use_cases/header_rewrite/block_personal_gmail_allow_google_corporate_accounts) — Prevent data leaks via personal email
- [Block Keywords in Uploads](/use_cases/data_leakage_prevention/block_emails_or_files_including_archives_or_social_posts_using_keywords) — Detect "confidential" in social posts
