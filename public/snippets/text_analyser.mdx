...
- Use [Compliance Templates](/use_cases/access_restriction/compliance_templates) for pattern-based detection starting points.
- Use [Content Moderation](/use_cases/data_leakage_prevention/content_analyser) to combine categorization, text, and image controls.
- Use [Security Logs](/use_cases/audit_and_forensics/security_logs) and [Reporting Module](/use_cases/audit_and_forensics/reporting_module) to validate policy outcomes and retain evidence.
