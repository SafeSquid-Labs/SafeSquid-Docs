...
- [Authentication](/use_cases/authentication/authentication) provides identity and group context
- [SSL Inspection](/use_cases/ssl_inspection/ssl_inspection) provides visibility into encrypted traffic
...
- Use [Request Profiles](/use_cases/profiling_engine/request_profiles) and [Response Profiles](/use_cases/profiling_engine/response_profiles) to classify traffic before enforcing policy.
- Use [Web Categorization](/getting_started/core_features/web_categorization) to refine destination-based decisions.
- Use [Security Logs](/use_cases/audit_and_forensics/security_logs) and [Reporting Module](/use_cases/audit_and_forensics/reporting_module) to prove which rule triggered.
