...
- Use [Content Moderation](/use_cases/data_leakage_prevention/content_analyser) to combine image, text, and categorization controls.
- Use [Text Analyzer](/use_cases/data_leakage_prevention/text_analyser) for body-content scoring that complements visual inspection.
- Use [Security Logs](/use_cases/audit_and_forensics/security_logs) and [Reporting Module](/use_cases/audit_and_forensics/reporting_module) to validate image-policy behavior and investigate false positives.
