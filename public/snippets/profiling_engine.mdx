...
### 1. [User Identities](/use_cases/authentication/user_identities) — Connect LDAP/AD, Create Groups
...
→ [Configure User Identities](/use_cases/authentication/user_identities)

---

### 2. [Web Categorization](/getting_started/core_features/web_categorization) — Assign Sites to Categories
...
→ [Configure Web Categorization](/getting_started/core_features/web_categorization)

---

### 3. [Architecture](/architecture/overview/safesquid_swg) — Detect Apps by Traffic Fingerprints
...
→ [Review the architecture guides](/architecture/overview/safesquid_swg)

---

### 4. [Content Analyser](/use_cases/data_leakage_prevention/content_analyser) — Inspect Files, Text, Images
...
→ [Configure Content Analyser](/use_cases/data_leakage_prevention/content_analyser)

---

### 5. [Request Profiles](/use_cases/profiling_engine/request_profiles) — Control by HTTP Method, Protocol, User-Agent
...
→ [Configure Request Profiles](/use_cases/profiling_engine/request_profiles)

---

### 6. [Response Profiles](/use_cases/profiling_engine/response_profiles) — Filter by MIME Type, File Size
...
→ [Configure Response Profiles](/use_cases/profiling_engine/response_profiles)

---

### 7. [Time Profiles](/use_cases/profiling_engine/time_profiles) — Enforce Policies by Time Window
...
→ [Configure Time Profiles](/use_cases/profiling_engine/time_profiles)
...
**Solution:** Use LDAP or SAML authentication. Configure [User Identities](/use_cases/authentication/user_identities) before building IP-based rules.
...
**Solution:** Enable [SSL Inspection](/use_cases/ssl_inspection/ssl_inspection) before relying on Content Analyser for DLP or malware detection.
...
**Prerequisites:**
- [Authentication Setup](/use_cases/authentication/authentication) — User identities require LDAP, AD, or SAML authentication

**Next Steps:**
- [Access Restrictions](/use_cases/access_restriction/access_restriction) — Use profiles to build allow/block policies
- [Data Leakage Prevention](/use_cases/data_leakage_prevention/data_leakage_prevention) — Combine Content Analyser with DLP templates

**Troubleshooting:**
- [User Not Identified](/troubleshooting/troubleshooting) — LDAP bind failures, group membership issues
- [Application Not Detected](/troubleshooting/troubleshooting) — Signature tuning, false positives
