...
- SafeSquid configured as the primary DNS resolver (see [Supporting Services: BIND](/architecture/interface/bind)).
...
1. [Access the SafeSquid User Interface](/architecture/interface/configuration_portal).
...
- Align resolver placement: [BIND](/architecture/interface/bind).
