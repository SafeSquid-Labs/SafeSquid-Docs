...
Follow [Configure HTTPS Inspection](/use_cases/ssl_inspection/ssl_inspection) and [Import certificate into Firefox](/use_cases/ssl_inspection/ssl_inspection) or Chrome/IE.
...
![Creating a new policy in request types under custom settings section](/images/troubleshooting/ssl_inspection_issues_01_creating_a_new_policy_in_request_types_under_cus.webp)

![Creating a policy by adding all the required values](/images/troubleshooting/ssl_inspection_issues_02_creating_a_policy_by_adding_all_the_required_val.webp)

![Creating a new policy in Access profiles section](/images/troubleshooting/ssl_inspection_issues_03_creating_a_new_policy_in_access_profiles_section.webp)

![adding the required values](/images/troubleshooting/ssl_inspection_issues_04_adding_the_required_values.webp)

![Clicking on Inspection policies in HTTPS inspection under Real time content security section](/images/troubleshooting/ssl_inspection_issues_05_clicking_on_inspection_policies_in_https_inspect.webp)

![Creating a new policy](/images/troubleshooting/ssl_inspection_issues_06_creating_a_new_policy.webp)

![showing settings to configure a security policy, allowing "block domain mismatch in the website ssl certificate"](/images/troubleshooting/ssl_inspection_issues_07_showing_settings_to_configure_a_security_policy_.webp)

![moving up the created policy just above the last policy](/images/troubleshooting/ssl_inspection_issues_08_moving_up_the_created_policy_just_above_the_last.webp)

![saving configuration globally](/images/troubleshooting/ssl_inspection_issues_09_saving_configuration_globally.webp)
