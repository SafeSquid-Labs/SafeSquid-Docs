...
- [SafeSquid Proxy Cluster](/architecture/overview/safesquid_proxy_cluster) for scale-out and failover design.
- [Monit Service Governance](/architecture/interface/supporting_services_monit) for process supervision.
- [Reporting Service](/architecture/interface/reporting_service) for audit and forensic evidence.

## Next steps

- Use [Integrated DNS Security](/architecture/overview/integrated_dns_security) to add DNS-layer protection.
- Use [Configure](/architecture/policy_management_console/configure) to manage policy through the console.
