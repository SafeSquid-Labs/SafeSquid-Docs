...
1. [SafeSquid SWG Overview](/architecture/overview/safesquid_swg) for the main product components and deployment model.
2. [Application Ecosystem](/architecture/application_ecosystem/main) for supporting services, feed dependencies, reporting, and portal relationships.
...
4. [Integrated DNS Security](/architecture/overview/integrated_dns_security) for DNS-layer enforcement and tunnelling risk.
