...
- Use [Logs and Audit Evidence](/architecture/files_and_folders/logs_and_audit_evidence) to verify service and log behavior.
- Use [Supporting Services](/architecture/interface/supporting_services) to validate Monit, BIND, and NTP dependencies.
