...
| Review temporary data, cache, report databases, SSL certificate cache, user data, and signature stores | [Runtime Data and Signatures](/architecture/files_and_folders/runtime_data_and_signatures) |
| Collect config, extended, native, performance, privacy, and process evidence | [Logs and Audit Evidence](/architecture/files_and_folders/logs_and_audit_evidence) |
