...
upload under [Subscription](/configuration/infrastructure_and_access/subscription) when renewing —
status then shows on the [Support](/configuration/infrastructure_and_access/support) page's License
Details panel.
...
[Configuration](/configuration/main) actually lives — it isn't a local console feature.
