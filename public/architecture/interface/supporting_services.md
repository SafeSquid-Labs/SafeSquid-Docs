...
**Install and configure:** [Monit Configuration Guide](/architecture/interface/supporting_services_monit)
...
**Install and configure:** [BIND Configuration Guide](/architecture/interface/bind)
...
**Install and configure:** [NTP Configuration Guide](/architecture/interface/ntp)
...
- Use [BIND](/architecture/interface/bind) to operate local DNS services.
- Use [NTP](/architecture/interface/ntp) to keep logs and authentication time-aligned.
