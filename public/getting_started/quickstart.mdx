...
<Steps>
  ...
  <Step title="Install the selected platform">
    Choose the approved install path in [Install SafeSquid](/getting_started/install_safesquid/main), then complete that platform guide.
...
- [Install SafeSquid](/getting_started/install_safesquid/main) - deploy the approved platform path.
