...
For full platform prerequisites, sizing decisions, and network dependencies, use [Deployment Checklist](/getting_started/install_safesquid/prerequisites) and [Deployment](/deployment/main).
...
Use [Deployment](/deployment/main) and [Deployment Checklist](/getting_started/install_safesquid/prerequisites) to complete these controls before installation.
...
- [Deployment](/deployment/main) - finalize ownership, topology, and rollback decisions.
