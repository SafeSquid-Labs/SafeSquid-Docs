...
For full platform prerequisites, sizing decisions, and network dependencies, use [Install Prerequisites](/getting_started/install_safesquid/prerequisites) and [Deployment](/deployment/main).
...
Use [Deployment](/deployment/main) and [Install Prerequisites](/getting_started/install_safesquid/prerequisites) to complete these controls before installation.
