...
For full platform prerequisites, sizing decisions, and network dependencies, use [Install Prerequisites](/getting_started/install_safesquid/prerequisites) and [Deployment Planning](/deployment/deployment_planning).
...
Use [Deployment Planning](/deployment/deployment_planning) and [Install Prerequisites](/getting_started/install_safesquid/prerequisites) to complete these controls before installation.
...
- [Deployment Planning](/deployment/deployment_planning) - finalize ownership, topology, and rollback decisions.
