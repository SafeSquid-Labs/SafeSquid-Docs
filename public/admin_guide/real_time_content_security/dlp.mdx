...
<Frame caption="DLP — DLP policies rows">
  <img src="/images/admin_guide/dlp-dlp_policies.webp" alt="SafeSquid console showing DLP policies rows with Upload Content type regexes for office document uploads, the Edit Policies icon on the first row circled" />
</Frame>
