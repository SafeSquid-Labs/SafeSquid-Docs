...
<Frame caption="SqScan — Virus scanning policies row">
  <img src="/images/admin_guide/sqscan-virus_scanning_policies.webp" alt="SafeSquid console showing a SqScan Virus scanning policies row with STANDARD Malware Security Level, the Edit Policies icon circled" />
</Frame>
