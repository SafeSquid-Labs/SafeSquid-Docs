...
<Frame caption="Text analyzer — Global fields">
  <img src="/images/admin_guide/text_analyzer-global.webp" alt="SafeSquid console showing Text analyzer Global fields with Threshold set to 100, the Edit Policy icon circled" />
</Frame>
