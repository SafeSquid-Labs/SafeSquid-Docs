...
<Frame caption="Redirect — Redirection policies rows">
  <img src="/images/admin_guide/redirect-redirection_policies.webp" alt="SafeSquid console showing Redirection policies rows enforcing search-engine safe search, the Edit Policies icon on the first row circled" />
</Frame>
