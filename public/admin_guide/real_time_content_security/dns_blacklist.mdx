...
<Frame caption="DNS Blacklist — DNS and IP Black Listing Policies rows">
  <img src="/images/admin_guide/dns_blacklist-policies.webp" alt="SafeSquid console showing DNS Blacklist policy rows with Threatful Categories including Malware and Phishing, the Edit Policies icon circled" />
</Frame>
