...
<Frame caption="Image analyzer — Filtering policies rows">
  <img src="/images/admin_guide/image_analyzer-filtering_policies.webp" alt="SafeSquid console showing Image analyzer Filtering policies rows with Threshold and Template fields, the Edit Policies icon on the first row circled" />
</Frame>
