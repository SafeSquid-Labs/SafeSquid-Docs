...
<Tabs>
  <Tab title="Cookie filter">
    ...
    {/* source: https://www.safesquid.com/md/cookies-filtering.md */}
    - **The built-in `Read Only` profile** is meant for Deny rows: apply it to a connection and matching cookies are blocked, so the user cannot stay signed in to that site. See the `cookie_profiles` catalog in [Suggested profiles](/admin_guide/custom_settings/suggested_profiles).
    ...
    <Frame caption="Privacy control — Cookie filter Global tab">
      <img src="/images/admin_guide/privacy_control-cookie_filter.webp" alt="SafeSquid console showing the Privacy control Cookie filter Global tab, with the Edit Policy icon circled" />
    </Frame>
  ...
  <Tab title="Header filter">
    ...
    See the `header_filter_profiles` catalog in [Suggested profiles](/admin_guide/custom_settings/suggested_profiles), which names these same tiers plus `DROP ORIGINAL CSP`.
    ...
    **Global** (Enabled/Policy), **Allow**, **Deny**, **Insert**, and **View headers** — the last
    ...
    <Frame caption="Privacy control — Header filter Global tab">
      <img src="/images/admin_guide/privacy_control-header_filter.webp" alt="SafeSquid console showing the Privacy control Header filter Global tab with its five sub-tabs, the Edit Policy icon circled" />
    </Frame>
  ...
  <Tab title="Elevated Privacy">
    ...
    <Frame caption="Privacy control — Elevated Privacy policy rows">
      <img src="/images/admin_guide/privacy_control-elevated_privacy.webp" alt="SafeSquid console showing Elevated Privacy policy rows with NOT-REQUIRED, PARANOID, and LOW privacy levels, the Edit Policies icon on the first row circled" />
    </Frame>
