...
<Note>
To enforce cookie behaviour, configure [Cookie filter](/admin_guide/filter/cookie_filter) and reference the same tag names in [Access Profiles](/admin_guide/policymgr/access_profiles) where `cookie_profiles` is used.
</Note>
