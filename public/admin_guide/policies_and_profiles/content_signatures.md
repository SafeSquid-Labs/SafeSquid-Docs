...
<Warning>
For live response labelling by MIME or extension, use [Response Types](/admin_guide/policies_and_profiles/response_profiles). Content Signatures rows still matter for database maintenance, autocomplete in other sections (for example DLP), and libmagic setup.
</Warning>
...
- [Response Types](/admin_guide/policies_and_profiles/response_profiles)
