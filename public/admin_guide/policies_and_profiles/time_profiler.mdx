...
The **Time Profiler** section (`safesquid-timeProfiles(5)`) tags connections with time labels from the appliance local clock. [Access Profiles](/admin_guide/policies_and_profiles/access_profiles) **Time Schedule** matches these tags.
