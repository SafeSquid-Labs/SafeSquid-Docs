...
<Frame caption="Network settings — Listen rows">
  <img src="/images/admin_guide/network_settings-listen.webp" alt="SafeSquid console showing Network settings Listen rows including an SSL_TRANSPARENT binding, the Edit Policies icon on the first row circled" />
</Frame>
...
<Frame caption="Network settings — Interface row">
  <img src="/images/admin_guide/network_settings-interface.webp" alt="SafeSquid console showing a Network settings Interface row with the ALTERNATE OUTBOUND IP profile, the Edit Policies icon circled" />
</Frame>
