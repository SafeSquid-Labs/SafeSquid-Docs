...
connection fields plus **Ldap Domain**, **Login Attributes**, and **Group Identifier** shown here
(the Ldap Password row is redacted from this capture).

<Frame caption="Integrate LDAP — LDAP servers row">
  <img src="/images/admin_guide/integrate_ldap-servers.webp" alt="SafeSquid console showing an LDAP servers row with Login Attributes and Group Identifier fields, Group Identifier circled" />
</Frame>
