...
<Frame caption="System configuration — Global fields">
  <img src="/images/admin_guide/system_configuration-global.webp" alt="SafeSquid console showing System configuration Global fields with Send Debugging Headers To set to CLIENT, the Edit Policy icon circled" />
</Frame>
...
- **Send Debugging Headers To (`dheaders`)** — CLIENT, SERVER, BOTH, or NONE — see [Debug headers](/admin_guide/start_here/debug_response_headers).
...
<Frame caption="System configuration — Compression and buffering policies row">
  <img src="/images/admin_guide/system_configuration-compression.webp" alt="SafeSquid console showing a Compression and buffering policies row with CONNECT ports and buffer size fields, the Edit Policies icon circled" />
</Frame>
