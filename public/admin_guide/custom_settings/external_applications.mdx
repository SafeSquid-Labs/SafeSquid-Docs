...
<Frame caption="External applications — Global tab">
  <img src="/images/admin_guide/external_applications-global.webp" alt="SafeSquid console showing the External applications Global tab with the Enabled toggle set to FALSE, the Edit Policy icon circled" />
</Frame>
