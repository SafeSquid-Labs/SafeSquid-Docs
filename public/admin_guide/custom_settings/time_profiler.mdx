...
<Frame caption="Time Profiler — Time profiles rows">
  <img src="/images/admin_guide/time_profiler-time_profiles.webp" alt="SafeSquid console showing Time profiles rows for office hours and lunch window, the Edit Policies icon on the first row circled" />
</Frame>
