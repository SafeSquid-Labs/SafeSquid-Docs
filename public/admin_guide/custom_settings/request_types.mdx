...
The **Request Types** section (`safesquid-reqProfiles(5)`) labels HTTP requests with tags consumed by [Access Profiles](/admin_guide/restriction_policies/access_profiles) and other filters. It does not block traffic.
