...
<Frame caption="Response Types — Response Types rows">
  <img src="/images/admin_guide/response_types-rows.webp" alt="SafeSquid console showing Response Types rows with the Content type regex field, the Edit Policies icon on the first row circled" />
</Frame>
