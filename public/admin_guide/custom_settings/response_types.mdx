...
The **Response Types** section (`safesquid-respProfiles(5)`) labels HTTP responses for [Access Profiles](/admin_guide/restriction_policies/access_profiles) and content filters. It does not block by itself.
