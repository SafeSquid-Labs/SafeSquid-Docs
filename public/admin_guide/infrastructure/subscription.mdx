...
2. When expired, [Application Signatures](/admin_guide/profilesdef/application_signatures) processing is skipped for that connection and security logging records filter `subscription`.
...
- [Tools](/admin_guide/utilities/tools_and_reports)
