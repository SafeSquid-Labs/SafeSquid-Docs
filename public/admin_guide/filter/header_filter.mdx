...
4. Enable System configuration debug response headers (see [Debug response headers](/admin_guide/reporting/debug_response_headers)) to inspect policy outcomes on the wire.
