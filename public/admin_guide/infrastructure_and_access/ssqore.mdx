...
Custom or local categories may also come from the [Categorize Web-Sites](/admin_guide/policies_and_profiles/web_categories) tool and DNS category zone settings in startup.ini; SSqore is the cloud lookup path.
