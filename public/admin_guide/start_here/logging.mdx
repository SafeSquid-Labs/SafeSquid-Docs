...
1. Confirm proxy host/port and [Listen](/admin_guide/network_and_access/network_settings_and_listeners).
...
3. If rows show access deny, fix [Access restrictions](/admin_guide/network_and_access/access_restrictions) (subnet, Interface, Default Access Policy).
</Tip>
