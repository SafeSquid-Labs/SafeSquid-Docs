...
- **[SSqore](/admin_guide/infrastructure_and_access/ssqore)** — CCS URL categorisation during request profiling. Globals: Enabled (Heuristic is stored but unused in current code).
