...
:::note
Restart SafeSquid service from the SafeSquid Interface will work, only if the [monit service](/Supporting_Services_Monit) is configured properly on the SafeSquid server.
:::
